      ...
      <div class="space-y-3">
        <div class="grid grid-cols-3 gap-2">
          ${actions.map(a => {
            ...
            return `
            <button class="flex flex-col items-center gap-2 p-3 rounded-xl bg-opal-surface-2/50 border border-opal-divider hover-brutal-accent cursor-pointer group">
        ...
        <div class="border-t border-opal-divider pt-3">
          ...
          <a href="https://github.com/jugridev/opal-redesign" target="_blank" rel="noopener noreferrer"
             class="inline-flex items-center gap-1.5 text-[10px] font-medium px-2.5 py-1 rounded-full bg-opal-surface-2 border border-opal-glass-border text-opal-text-muted hover:text-opal-text hover:border-opal-accent/50 hover:bg-opal-accent/10 transition-all">
